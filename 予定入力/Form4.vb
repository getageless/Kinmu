...
Public Class frm法定外実地教育
    ...
    Private Sub RB_Sonota_CheckedChanged(sender As Object, e As EventArgs) Handles RB_Sonota.CheckedChanged
        strKoumoku = RB_Sonota.Text
    End Sub

    Private Sub RB_Monitor_CheckedChanged(sender As Object, e As EventArgs) Handles RB_Monitor.CheckedChanged
        txtBikou.Text = RB_Monitor.Text
    End Sub


    Private Sub RB_Kennmi_CheckedChanged(sender As Object, e As EventArgs) Handles RB_Kennmi.CheckedChanged
        txtBikou.Text = RB_Kennmi.Text
    End Sub


    Private Sub RB_Sutanbai_CheckedChanged(sender As Object, e As EventArgs) Handles RB_Sutanbai.CheckedChanged
        txtBikou.Text = RB_Sutanbai.Text
    End Sub


    Private Sub RB_Kensyu_CheckedChanged(sender As Object, e As EventArgs) Handles RB_Kensyu.CheckedChanged
        txtBikou.Text = RB_Kensyu.Text
    End Sub
End Class